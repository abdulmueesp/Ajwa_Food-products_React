...
const About = () => {
  return (
    <div>
      <div className="w-full h-[630px] slg:h-[380px]  flex flex-col slg:flex-row pt-8 bg-[#f5f5f5]">
        {/* first box  */}
      ...
      {/* heading manufacture */}
      <div className="w-full h-[100px] md:h-[120px]  bg-[#f5f5f5] text-gray-600 flex justify-center items-center text-lg md:text-xl slg:text-2xl font-local4 font-semibold underline">
        <h1>Steps in Our Product Manufacturing</h1>
      </div>
      <Aboutbox
        head1={"Copra Purchase and Sorting"}
        paragraph1={
          "Milling grade copra is sourced for coconut oil production, mainly from coastal regions and Kangeyam, Tamil Nadu. The sun-dried, cup-shaped copra has a white inner surface and brown outer. It is inspected for quality, and impurities like coconut shell, low-quality copra, and jute threads are removed."
        }
        head2={"Copra Drying Process"}
        paragraph2={
          "Copra is loaded into a 9-ton hopper, where hot air at 75-80°C is pumped for 10 hours, reducing moisture from 5% to 2.5%. This drying process makes the copra hard and brittle, improving the shelf life of the oil by preventing rancidity. Moisture-free copra also allows for finer filtration during oil extraction."
        }
        img={Machine}
      />
      <Aboutbox
        head1={"Copra Cutting"}
        paragraph1={
          "Milling copra, in irregular shapes, is cut into 1-inch pieces using a motorized cutter. The beaters reduce the size, and smaller pieces escape through a mesh. Uniform cutting ensures even roasting, and the pieces are transported via a screw conveyor."
        }
        head2={"Copra Roasting/Cooking"}
        paragraph2={
          "Copra pieces are roasted in a steam jacketed vessel for about an hour with continuous agitation. Steam is sprayed for better cooking, improving oil recovery and aroma. The process sterilizes the copra, enhancing the shelf life of the coconut oil."
        }
        img={Roastingimg}
      />
      <Aboutbox
        ...
        paragraph1={
          "Dried and roasted copra is crushed in an expeller to extract oil, leaving behind oil cake with about 8% oil. Crushing is done in two stages to maximize oil recovery. About 63% of copra is oil, and the remaining is oil cake, which is sold for cattle feed or further extraction."
        }
        ...
        img={machine2}
      />
      <div className="w-full h-[50px] bg-[#f5f5f5] "></div>
    </div>
  );
};
