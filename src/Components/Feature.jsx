...
const Feature = () => {
  return (
    <div>
       <div className='w-full h-[560px] 45hsize:h-[480px] md:h-[580px] lg:h-[650px]   bg-[#f5f5f5] flex flex-col items-center space-y-4 pt-8 '>
          {/* heading  */}
           <div className='w-[300px] h-min  font-local4 text-xl 45hsize:text-2xl lg:text-3xl font-extrabold flex flex-col items-center justify-center'>
              <h1>Featured Products</h1>
              <div className='w-[170px] 45hsize:w-[215px] lg:w-[260px] h-[1px] bg-green-700'></div>
           </div>
           {/* img section  */}
           <div>
            ...
            {/* description  */}
           <div className='w-[340px] 45hsize:w-[440px] xs:w-[540px] md:w-[700px] slg:w-[800px] lg:w-[1000px] h-min font-local2 font-bold  text-base lg:text-xl '>
